...
const WaiterSidebar = () => {
    ...
    return (
        <aside className="w-64 bg-white shadow-[2px_0_15px_-3px_rgba(0,0,0,0.05)] h-screen sticky top-0 flex flex-col transition-all duration-300 z-20 border-r border-gray-100">
            {/* Header */}
